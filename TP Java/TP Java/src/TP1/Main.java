...
// Classe TP1.Main contenant le programme principal main
public class Main {
    public static void main(String[] args) {
        ...
        /*
          A COMPLETER : définir et instancier un objet de la classe TP1.Etudiant sans parametre
         */
        Etudiant etudiant = new Etudiant();

        /*
            A COMPLETER : Appeler la methode getNom() de l'objet instancie ci-dessus de la classe TP1.Etudiant, pour
                          recuperer la variable nom saisie dans cette méthode pour cet objet.
         */
        nom = etudiant.getNom();

         /*
            A COMPLETER : Appeler la methode getAge() de l'objet instancie ci-dessus de la classe TP1.Etudiant, pour
                          recuperer la variable age saisie dans cette méthode pour cet objet.
         */
        age = etudiant.getAge();

         /*
            A COMPLETER : Appeler la methode getNbnotes() de l'objet instancie ci-dessus de la classe TP1.Etudiant, pour
                          recuperer la variable nbnotes saisie dans cette méthode pour cet objet.
         */
        nbnotes = etudiant.getNbnotes();

         /*
            A COMPLETER : Appeler la methode getNotes(int nbnotes) de l'objet instancie ci-dessus de la classe TP1.Etudiant,
        ...
        /*
            A COMPLETER : Appeler la methode afficherInfos() de l'objet instancie ci-dessus de la classe TP1.Etudiant, pour
                          afficher les informations de cet objet.
         */
        etudiant.afficherInfos();

        /*
            A COMPLETER : Appeler la methode calculerMoyenne() de l'objet instancie ci-dessus de la classe TP1.Etudiant,
